...
subtitle: "`r paste0('published in ', bibtex::read.bib('cite.bib')$journal)`" 
date: "2022-02-08"
featured: true
...
format_author <- function(authors) {
  formatted_authors <- sapply(authors, function(author) {
    ...
    if (grepl('Torres Mungu[ií]a', full_name, ignore.case = TRUE)) {
      full_name <- paste0(full_name, '<a href="https://orcid.org/0000-0003-3432-6941"><img src="https://fontawesome.com/icons/orcid?f=brands&s=solid" height="16" width="16" ></a>')
    }
    return(full_name)
  })
