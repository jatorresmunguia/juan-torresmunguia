...
- icon: file-pdf
  icon_pack: fas
  name: PDF
  url: "`r paste0(bibtex::read.bib('cite.bib')$url)`" 
- icon: link
  icon_pack: fas
  name: DOI
...
if (grepl('Torres Mungu[ií]a', full_name, ignore.case = TRUE)) {
      full_name <- paste0(full_name, '<a href="https://orcid.org/0000-0003-3432-6941" target="_blank"><img src="https://fontawesome.com/icons/orcid?f=brands&s=solid" height="16" width="16" ></a>')
    }
    return(full_name)
  })
